...
public class BarCodeGenerator {
    ...
    // generate qrcode
    public static void generateQrCode(Context context, String title, String documentType, String id)  {
        String myCodeText = getFormat(documentType,id);
    ...
    public static String getFormat(String documentType, String id){
        String str;
        str = Utility.GetDocumentFileName(documentType,id)+","+documentType+","+Utility.companyId;
        return str;
