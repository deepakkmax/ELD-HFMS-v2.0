...
public class GpsSkyFragment extends Fragment implements GpsFragment.GpsSignalListener {
    ...
    private static class GpsSkyView extends View implements GpsFragment.GpsSignalListener {
